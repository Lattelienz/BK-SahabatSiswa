<div class="formbold-form-step-3">
  ...
  <div class="formbold-input-flex mb-2">
    <div>
      ...
      <input type="text" name="kendaraan" id="kendaraan" placeholder="Kendaraan/Diantar" class="formbold-form-input"/>
    </div>
  </div>
  ...
  <div>
    ...
    <div class="formbold-radio-flex flex-column flex-sm-row">
      ...
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="tempat_tinggal" id="tempat_tinggal" value="Lainnya">
          Lainnya
          <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
    ...
    <input type="text" class="formbold-form-input mt-3 d-none" name="tempat_tinggal_lain" id="tempat_tinggal_lainnya" disabled>
  </div>
  ...
  <div class="mt-3">
    ...
    <div class="formbold-radio-flex flex-column flex-sm-row">
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="penerangan" id="penerangan" value="Listrik">
        Listrik
        <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="penerangan" id="penerangan" value="Lampu tembok">
        Lampu Tembok
        <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="penerangan" id="penerangan" value="Lilin">
        Lilin
        <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="penerangan" id="penerangan" value="Lainnya">
        Lainnya
        <span class="formbold-radio-checkmark"></span>
      </label>
      </div>
    ...
    <input type="text" class="formbold-form-input mt-3 d-none" name="penerangan_lain" id="penerangan_lainnya" disabled>
  </div>
  ...
  <div class="formbold-input-flex">
    ...
    <div class="d-flex flex-column flex-sm-row">
      ...
      <div class="mb-2 mx-0 mx-sm-2 formbold-radio-flex flex-column flex-sm-row">
        <div class="formbold-radio-group">
          <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="hp" id="hp" value="punya">
          Ada
          <span class="formbold-radio-checkmark"></span>
          </label>
        </div>
        <div class="formbold-radio-group">
          <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="hp" id="hp" value="tidak">
          Tidak
          <span class="formbold-radio-checkmark"></span>
          </label>
        </div>
    ...
    <div class="d-flex flex-column flex-sm-row">
      ...
      <div class="mb-2 mx-0 mx-sm-2 formbold-radio-flex flex-column flex-sm-row">
        <div class="formbold-radio-group">
          <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="laptop" id="laptop" value="punya">
          Ada
          <span class="formbold-radio-checkmark"></span>
          </label>
        </div>
        <div class="formbold-radio-group">
          <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="laptop" id="laptop" value="tidak">
          Tidak
          <span class="formbold-radio-checkmark"></span>
          </label>
        </div>
  ...
  <div class="mt-3">
    ...
    <div class="formbold-radio-flex flex-column flex-sm-row">
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="pjj" id="pjj" value="Wifi sendiri">
        WIFI Sendiri
        <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="pjj" id="pjj" value="Wifi tetangga">
        WIFI Tetangga
        <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
        <input class="formbold-input-radio" type="radio" name="pjj" id="pjj" value="Kuota">
        Kuota
        <span class="formbold-radio-checkmark"></span>
      </label>
      </div>
      <div class="formbold-radio-group">
        <label class="formbold-radio-label">
          <input class="formbold-input-radio" type="radio" name="pjj" id="pjj" value="Lainnya">
          Lainnya
          <span class="formbold-radio-checkmark"></span>
        </label>
      </div>
    ...
    <input type="text" class="formbold-form-input mt-3 d-none" name="pjj_lain" id="pjj_lainnya" disabled>
  </div>

  <div class="mt-3">
    <label for="not_fav_mapel" class="formbold-form-label"> Pelajaran Yang Kurang Disenangi : </label>
    <input type="text" name="not_fav_mapel" placeholder="" id="not_fav_mapel" class="formbold-form-input" />
  </div>

  <div class="mt-3">
    <label for="fav_mapel" class="formbold-form-label"> Pelajaran Yang Disenangi : </label>
    <input type="text" name="fav_mapel" placeholder="" id="fav_mapel" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="cita_cita" class="formbold-form-label"> Cita-cita Setelah Tamat SMKN 2 : </label>
    <input type="text" name="cita_cita" placeholder="" id="cita_cita" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="hobi" class="formbold-form-label"> Hobby / Kegemaran : </label>
    <input type="text" name="hobi" placeholder="" id="hobi" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="curhat" class="formbold-form-label"> Tempat Mencurahkan Isi Hati : </label>
    <input type="text" name="curhat" placeholder="" id="curhat" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="penyakit" class="formbold-form-label"> Penyakit Yang Diderita (Yang Mengganggu Belajar) : </label>
    <input type="text" name="penyakit" placeholder="" id="penyakit" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="bahasa" class="formbold-form-label"> Bahasa Yang Digunakan : </label>
    <input type="text" name="bahasa" placeholder="" id="bahasa" class="formbold-form-input"/>
  </div>

  <div class="mt-3">
    <label for="suku" class="formbold-form-label"> Suku : </label>
    <input type="text" name="suku" placeholder="" id="suku" class="formbold-form-input"/>
  </div>
</div>